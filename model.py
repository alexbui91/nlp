...
class Model:
    ...
    def initNetwork(self):
        ...
        for fh in self.filter_size:
            ...
            # filter_shape: (number of filters, num input feature maps,height, width) feature_size is the number of features,  stack_size is number of channel
            # input_shape: (batch_size, stack_size, image_height, image_width),
